...
HD_PWD='D:/Tsinghua/2018autumn/VivadoProject/project_3_port/project_3_port.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PortController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PortController.tcl -notrace
