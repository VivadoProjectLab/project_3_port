...
HD_PWD='D:/Tsinghua/2018autumn/VivadoProject/project_3_port/project_3_port.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PortController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PortController.tcl
